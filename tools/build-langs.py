...
for _lang in ("en", "fr"):
    PROJEKT_ABSAETZE[_lang][NEUES_PROJEKT["id"]] = NEUES_PROJEKT["desc"][_lang]
...
def transform(src: str, lang: str, page: str) -> str:
    ...
    # --- Neuntes Projekt in die Liste aufnehmen ---------------------------
    # Der Eintrag wird an das Ende von BASE_PROJECTS gehaengt und die
    # Kennzeichnung an alle drei metas-Listen, die nach Position zugeordnet
    # sind. Beides vor der Umschreibung der Bildpfade, damit der Pfad denselben
    # Weg nimmt wie die uebrigen. Die deutschen Absaetze kommen hier hinein und
    # werden anschliessend wie die uebrigen uebersetzt.
    if page == "Projects.html":
        n = NEUES_PROJEKT
        absaetze = ",\\n    ".join("'" + a + "'" for a in n["desc"]["de"])
        eintrag = (
            "  { id: '" + n["id"] + "', src: '" + n["src"] + "', "
            "alt: '" + n["alt"] + "', title: '" + n["title"] + "', "
            "year: " + str(n["year"]) + ", placeholder: '" + n["placeholder"] + "', "
            "desc: [\\n    " + absaetze + ",\\n  ] },\\n"
        )
        sub_once("\\n];\\n\\nclass Component extends DCLogic",
                 "\\n" + eintrag + "];\\n\\nclass Component extends DCLogic",
                 "neues Projekt in BASE_PROJECTS")
        for sprache, letzte in (("de", "Bergrennwagen"), ("en", "Hill-Climb Racer"),
                                ("fr", "Voiture de côte")):
            sub_once("'" + letzte + "']",
                     "'" + letzte + "', '" + n["meta"][sprache] + "']",
                     f"Kennzeichnung {sprache}")
        sub_once('hint-placeholder-count=\\"8\\"',
                 'hint-placeholder-count=\\"9\\"',
                 "Zahl der Platzhalter")
    ...
    new_media = (
        ...
        '       Apple nennt 44x44 Punkte als Mindestmass, darunter trifft man sie\\n'
        '       mit dem Finger nicht verlaesslich. Der Firmenname darf dafuer\\n'
        '       umbrechen; die Schrift der Kuerzel waechst von 10 auf 14 Pixel. */\\n'
        ...
        '    h1 { white-space: normal !important; }\\n'
        '    /* Safari auf dem iPhone zoomt die Seite hinein, sobald ein\\n'
        '       Eingabefeld mit weniger als 16px Schrift den Fokus bekommt.\\n'
        '       Danach steht die Seite verschoben da und muss von Hand\\n'
        '       zurueckgezogen werden. 16px verhindert das. */\\n'
        '    .field { font-size: 16px !important; }\\n'
        '    /* Verweise in der Fusszeile waren 18 Pixel hoch. Mit dem Finger\\n'
        '       trifft man sie schlecht, und sie liegen dicht beieinander. */\\n'
        '    footer a { min-height: 44px !important; display: inline-flex !important;\\n'
        '               align-items: center !important; }\\n'
        '    /* Untere Bildschirmkante: Auf Geraeten mit Streifen statt\\n'
        '       Home-Knopf liegt der Hinweis sonst teilweise darunter. */\\n'
        '    #orca-cookie-banner { padding: 16px 18px !important;\\n'
        '                          padding-bottom: max(16px, env(safe-area-inset-bottom)) !important; }\\n'
        '    /* Alle Schaltflaechen auf Mindestmass, auch die zum Laden der\\n'
        '       Karte auf der Kontaktseite (war 37 Pixel hoch). */\\n'
        '    button { min-height: 44px !important; }\\n'
        '    /* Das Laufband ist seit Kurzem ein Verweis auf die Projektseite. */\\n'
        '    .orca-ticker { min-height: 44px !important; }\\n'        '    #orca-cookie-banner button { min-height: 44px !important; }\\n'
        '    #orca-cookie-banner a { min-height: 44px !important;\\n'
        '                            display: inline-flex !important;\\n'
        '                            align-items: center !important; }\\n'
        '    /* Telefon, E-Mail und Instagram im Kontaktblock: 21 Pixel hoch und\\n'
        '       damit schlecht zu treffen. Ueber das Ziel angesprochen, weil die\\n'
        '       Klassen dieser Verweise vom Baukasten erzeugt werden. */\\n'
        '    section a[href^=\\"tel:\\"],\\n'
        '    section a[href^=\\"mailto:\\"],\\n'
        '    section a[href*=\\"instagram\\"] { min-height: 44px !important;\\n'
        '                                    display: inline-flex !important;\\n'
        '                                    align-items: center !important; }\\n'
        '    header > a.logo-link { min-height: 44px !important;\\n'
        '                          display: inline-flex !important;\\n'
        '                          align-items: center !important; }\\n'
        '  }\\n'
        '  /* Handy im Querformat: Dort greifen die Regeln oben nicht, weil das\\n'
        '     Fenster breiter als 820 Pixel ist — der Hero stand mit 600 Pixeln\\n'
        '     in einem 393 Pixel hohen Fenster und war anderthalb Bildschirme\\n'
        '     hoch. Ueber die Fensterhoehe angesprochen, nicht die Breite. */\\n'
        '  @media (max-height: 500px) and (orientation: landscape) {\\n'
        '    .orca-hero { height: 100vh !important; height: 100dvh !important;\\n'
        '                 min-height: 0 !important; }\\n'
        '    .orca-hero-text { bottom: 84px !important; }\\n'
        '  }\\n'
        ...
        '    /* max() haelt den sicheren Bereich frei: Ein iPhone im Querformat\\n'
        '       ist 852 Pixel breit, faellt also in diesen Bereich — und dort\\n'
        '       liegt die Kamera-Insel seitlich ueber dem Inhalt. */\\n'
        '    header { padding-left: max(32px, env(safe-area-inset-left)) !important;\\n'
